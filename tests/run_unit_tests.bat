...
REM =============================================================================
echo [1/27] Testing PIP/PIPCost/LotAmount formulas...
...
REM =============================================================================
echo [2/27] Testing multi-asset position parsing...
...
REM =============================================================================
echo [3/27] Testing IMPORTED trade position tracking...
...
REM =============================================================================
echo [4/27] Testing EIP-712 mainnet vs testnet source...
...
REM =============================================================================
echo [5/27] Testing utility functions...
...
REM =============================================================================
echo [6/27] Testing GET_PRICE context isolation...
...
REM =============================================================================
echo [7/27] Testing trigger order construction...
...
REM =============================================================================
echo [8/27] Testing partial fill detection...
...
REM =============================================================================
echo [9/27] Testing lotSize division-by-zero guard...
...
REM =============================================================================
echo [10/27] Testing WebSocket parsers...
...
REM =============================================================================
echo [11/27] Testing TWAP order construction...
...
REM =============================================================================
echo [12/27] Testing scheduleCancel signing...
...
REM =============================================================================
echo [13/27] Testing batchModify encoding...
...
REM =============================================================================
echo [14/27] Testing bracket order encoding...
...
REM =============================================================================
echo [15/27] Testing trading service logic...
...
REM =============================================================================
echo [16/27] Testing account service logic...
...
REM =============================================================================
echo [17/27] Testing market service logic...
...
REM =============================================================================
echo [18/27] Testing market service HTTP parsing...
...
REM =============================================================================
echo [19/27] Testing account service HTTP parsing...
...
REM =============================================================================
echo [20/27] Testing account service WS cache interactions...
...
REM =============================================================================
echo [21/27] Testing market service WS cache interactions...
...
REM =============================================================================
echo [22/27] Testing ALO order type (CR-1, CR-4, CR-5)...
...
REM =============================================================================
echo [23/27] Testing ALO execution (CR-2, CR-6..CR-9)...
...
REM =============================================================================
echo [24/27] Testing HL_EXPORT_ACCOUNT NFA column...
...
REM =============================================================================
echo [25/27] Testing unified account collateral...
...
REM =============================================================================
echo [26/27] Testing HTTP transport...
...
REM =============================================================================
echo [27/27] Testing exchange order ID lookup...
