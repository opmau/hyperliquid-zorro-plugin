...
REM =============================================================================
echo [1/25] Testing PIP/PIPCost/LotAmount formulas...
...
REM =============================================================================
echo [2/25] Testing multi-asset position parsing...
...
REM =============================================================================
echo [3/25] Testing IMPORTED trade position tracking...
...
REM =============================================================================
echo [4/25] Testing EIP-712 mainnet vs testnet source...
...
REM =============================================================================
echo [5/25] Testing utility functions...
...
REM =============================================================================
echo [6/25] Testing GET_PRICE context isolation...
...
REM =============================================================================
echo [7/25] Testing trigger order construction...
...
REM =============================================================================
echo [8/25] Testing partial fill detection...
...
REM =============================================================================
echo [9/25] Testing lotSize division-by-zero guard...
...
REM =============================================================================
echo [10/25] Testing WebSocket parsers...
...
REM =============================================================================
echo [11/25] Testing TWAP order construction...
...
REM =============================================================================
echo [12/25] Testing scheduleCancel signing...
...
REM =============================================================================
echo [13/25] Testing batchModify encoding...
...
REM =============================================================================
echo [14/25] Testing bracket order encoding...
...
REM =============================================================================
echo [15/25] Testing trading service logic...
...
REM =============================================================================
echo [16/25] Testing account service logic...
...
REM =============================================================================
echo [17/25] Testing market service logic...
...
REM =============================================================================
echo [18/25] Testing market service HTTP parsing...
...
REM =============================================================================
echo [19/25] Testing account service HTTP parsing...
...
REM =============================================================================
echo [20/25] Testing account service WS cache interactions...
...
REM =============================================================================
echo [21/25] Testing market service WS cache interactions...
...
REM =============================================================================
echo [22/25] Testing ALO order type (CR-1, CR-4, CR-5)...
...
REM =============================================================================
echo [23/25] Testing ALO execution (CR-2, CR-6..CR-9)...
...
REM =============================================================================
echo [24/25] Testing HL_EXPORT_ACCOUNT NFA column...
...
REM =============================================================================
echo [25/25] Testing unified account collateral...
