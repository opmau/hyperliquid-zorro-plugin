...
REM =============================================================================
echo [1/26] Testing PIP/PIPCost/LotAmount formulas...
...
REM =============================================================================
echo [2/26] Testing multi-asset position parsing...
...
REM =============================================================================
echo [3/26] Testing IMPORTED trade position tracking...
...
REM =============================================================================
echo [4/26] Testing EIP-712 mainnet vs testnet source...
...
REM =============================================================================
echo [5/26] Testing utility functions...
...
REM =============================================================================
echo [6/26] Testing GET_PRICE context isolation...
...
REM =============================================================================
echo [7/26] Testing trigger order construction...
...
REM =============================================================================
echo [8/26] Testing partial fill detection...
...
REM =============================================================================
echo [9/26] Testing lotSize division-by-zero guard...
...
REM =============================================================================
echo [10/26] Testing WebSocket parsers...
...
REM =============================================================================
echo [11/26] Testing TWAP order construction...
...
REM =============================================================================
echo [12/26] Testing scheduleCancel signing...
...
REM =============================================================================
echo [13/26] Testing batchModify encoding...
...
REM =============================================================================
echo [14/26] Testing bracket order encoding...
...
REM =============================================================================
echo [15/26] Testing trading service logic...
...
REM =============================================================================
echo [16/26] Testing account service logic...
...
REM =============================================================================
echo [17/26] Testing market service logic...
...
REM =============================================================================
echo [18/26] Testing market service HTTP parsing...
...
REM =============================================================================
echo [19/26] Testing account service HTTP parsing...
...
REM =============================================================================
echo [20/26] Testing account service WS cache interactions...
...
REM =============================================================================
echo [21/26] Testing market service WS cache interactions...
...
REM =============================================================================
echo [22/26] Testing ALO order type (CR-1, CR-4, CR-5)...
...
REM =============================================================================
echo [23/26] Testing ALO execution (CR-2, CR-6..CR-9)...
...
REM =============================================================================
echo [24/26] Testing HL_EXPORT_ACCOUNT NFA column...
...
REM =============================================================================
echo [25/26] Testing unified account collateral...
...
REM =============================================================================
echo [26/26] Testing HTTP transport...
