...
[PreviousNotationchevron-left](/hyperliquid-docs/for-developers/api/notation)[NextTick and lot sizechevron-right](/hyperliquid-docs/for-developers/api/tick-and-lot-size)
