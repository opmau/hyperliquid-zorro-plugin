...
[PreviousError responseschevron-left](/hyperliquid-docs/for-developers/api/error-responses)[NextRate limits and user limitschevron-right](/hyperliquid-docs/for-developers/api/rate-limits-and-user-limits)
