...
### [hashtag](#address-based-limits) Address-based limits
...
### [hashtag](#batched-requests) Batched Requests
...
[PreviousSigningchevron-left](/hyperliquid-docs/for-developers/api/signing)[NextActivation gas feechevron-right](/hyperliquid-docs/for-developers/api/activation-gas-fee)
