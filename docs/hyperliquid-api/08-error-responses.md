...
For API users that use historical orders, a list of all the cancel / reject historical order statuses can be found [herearrow-up-right](https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint#query-order-status-by-oid-or-cloid).

[PreviousTimeouts and heartbeatschevron-left](/hyperliquid-docs/for-developers/api/websocket/timeouts-and-heartbeats)[NextSigningchevron-right](/hyperliquid-docs/for-developers/api/signing)
